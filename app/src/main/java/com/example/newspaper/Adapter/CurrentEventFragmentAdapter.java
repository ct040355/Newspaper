...
public class CurrentEventFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<NewsItem> newsItemArrayList;
    private Context context;
    private OnClickItemCurrent onClickItemCurrent;

    private static int TYPE_SMALL = 1;
    private static int TYPE_BIG = 2;


    public void setOnClickItemCurrent(OnClickItemCurrent onClickItemCurrent) {
        this.onClickItemCurrent = onClickItemCurrent;
    }

    public CurrentEventFragmentAdapter(ArrayList<NewsItem> newsItemArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (TYPE_SMALL == holder.getItemViewType()){
            CurrentEventFragmentAdapter.SmallViewHolder smallViewHolder = (CurrentEventFragmentAdapter.SmallViewHolder) holder;
            ...
            smallViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onClickItemCurrent != null){
                        onClickItemCurrent.onClickItem(position,newsItem);
        ...
        if (TYPE_BIG == holder.getItemViewType()){
            CurrentEventFragmentAdapter.BigViewHolder bigViewHolder = (CurrentEventFragmentAdapter.BigViewHolder) holder;
    ...
    public interface OnClickItemCurrent{
