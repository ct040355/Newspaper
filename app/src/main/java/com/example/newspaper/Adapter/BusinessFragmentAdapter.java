...
public class BusinessFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<NewsItem> newsItemArrayList;
    private Context context;
    private OnClickItemBusiness onClickItemBusiness;

    private static int TYPE_SMALL = 1;
    private static int TYPE_BIG = 2;


    public void setOnClickItemBusiness(OnClickItemBusiness onClickItemBusiness) {
        this.onClickItemBusiness = onClickItemBusiness;
    }

    public BusinessFragmentAdapter(ArrayList<NewsItem> newsItemArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (TYPE_SMALL == holder.getItemViewType()){
            BusinessFragmentAdapter.SmallViewHolder smallViewHolder = (BusinessFragmentAdapter.SmallViewHolder) holder;
            ...
            smallViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onClickItemBusiness != null){
                        onClickItemBusiness.onClickItem(position,newsItem);
        ...
        if (TYPE_BIG == holder.getItemViewType()){
            BusinessFragmentAdapter.BigViewHolder bigViewHolder = (BusinessFragmentAdapter.BigViewHolder) holder;
    ...
    public interface OnClickItemBusiness{
