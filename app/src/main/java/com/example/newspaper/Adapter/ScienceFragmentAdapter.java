...
public class ScienceFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<NewsItem> newsItemArrayList;
    private Context context;
    private OnClickItemScience onClickItemScience;

    private static int TYPE_SMALL = 1;
    private static int TYPE_BIG = 2;


    public void setOnClickItemScience(OnClickItemScience onClickItemScience) {
        this.onClickItemScience = onClickItemScience;
    }

    public ScienceFragmentAdapter(ArrayList<NewsItem> newsItemArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (TYPE_SMALL == holder.getItemViewType()){
            ScienceFragmentAdapter.SmallViewHolder smallViewHolder = (ScienceFragmentAdapter.SmallViewHolder) holder;
            ...
            smallViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onClickItemScience != null){
                        onClickItemScience.onClickItem(position,newsItem);
        ...
        if (TYPE_BIG == holder.getItemViewType()){
            ScienceFragmentAdapter.BigViewHolder bigViewHolder = (ScienceFragmentAdapter.BigViewHolder) holder;
    ...
    public interface OnClickItemScience{
