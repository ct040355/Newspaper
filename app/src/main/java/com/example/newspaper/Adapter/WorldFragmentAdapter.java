...
public class WorldFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<NewsItem> newsItemArrayList;
    private Context context;
    private OnClickItemWorld onClickItemWorld;

    private static int TYPE_SMALL = 1;
    private static int TYPE_BIG = 2;


    public void setOnClickItemWorld(OnClickItemWorld onClickItemWorld) {
        this.onClickItemWorld = onClickItemWorld;
    }

    public WorldFragmentAdapter(ArrayList<NewsItem> newsItemArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (TYPE_SMALL == holder.getItemViewType()){
            WorldFragmentAdapter.SmallViewHolder smallViewHolder = (WorldFragmentAdapter.SmallViewHolder) holder;
            ...
            smallViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onClickItemWorld != null){
                        onClickItemWorld.onClickItem(position,newsItem);
        ...
        if (TYPE_BIG == holder.getItemViewType()){
            WorldFragmentAdapter.BigViewHolder bigViewHolder = (WorldFragmentAdapter.BigViewHolder) holder;
