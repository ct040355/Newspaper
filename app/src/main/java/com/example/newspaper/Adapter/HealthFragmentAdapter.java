...
public class HealthFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private OnClickItemHealth onClickItemHealth;

    private static int TYPE_SMALL = 1;
    private static int TYPE_BIG = 2;


    public void setOnClickItemHealth(OnClickItemHealth onClickItemHealth) {
        this.onClickItemHealth = onClickItemHealth;
    }

    public HealthFragmentAdapter(ArrayList<NewsItem> newsItemArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (TYPE_SMALL == holder.getItemViewType()){
            HealthFragmentAdapter.SmallViewHolder smallViewHolder = (HealthFragmentAdapter.SmallViewHolder) holder;
            ...
            smallViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onClickItemHealth != null){
                        onClickItemHealth.onClickItem(position,newsItem);
        ...
        if (TYPE_BIG == holder.getItemViewType()){
            HealthFragmentAdapter.BigViewHolder bigViewHolder = (HealthFragmentAdapter.BigViewHolder) holder;
    ...
    public interface OnClickItemHealth{
